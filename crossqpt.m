function M = crossqpt(q)
% CROSSQPT Quaternion multiplication matrix (+T)
%
% M = CROSSQPT(q) computes the multiplication matrix form of a [4x1]
% quaternion [q]. 
% If [q] is a matrix [4xn] the output [M] will be [4x4xn].
% Supports also symbolic variables. 
%
% see also CROSSM, CROSSMT, CROSSQP, CROSSQMT, CROSSQM.
